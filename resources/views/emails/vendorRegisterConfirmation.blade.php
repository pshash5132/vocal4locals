                ...
                <div class="col-lg-12">
                    <table style="width: 100%; max-width: 640px; margin: 0 auto;">
                        ...
                        <tbody style="margin: 50px auto 0 !important; width: 100%; display: block; max-width: 560px; border: 1px solid #374850; border-radius: 10px;padding: 43px 35px;">
                            <tr>
                                <td style="font-size: 24px; font-weight: 600; color: #374850;">Welcome {{$vendor->name}},</td>
                            </tr>
                            <tr>
                                <td style="font-size: 16px; color: #374850; line-height: 30px; font-weight: 400; margin-top: 15px; display: block;">
                                    Your account has been successfully activated. You can now log in using your registered credentials to access vocalforlocals and begin setting up your products. Let's take your business to the next level together!
                                </td>
                            </tr>

                            <tr style="flex-direction: column; display: flex; margin-top: 30px;">
                                <td style="display: flex; align-items: center; font-size: 16px; color: #374850; width: 100%;"><span style="display: block; width: 20%;">Name :</span>  <p style="color: #2672EC; font-weight: 600; line-height: 30px; font-size: 16px; margin-bottom: 0;">{{$vendor->name}}</p> </td>
                                <td style="display: flex; align-items: center; font-size: 16px; color: #374850; width: 100%;"> <span style="display: block; width: 20%;">Email  : </span>  <p style="color: #2672EC; font-weight: 600; line-height: 30px; font-size: 16px; margin-bottom: 0;">{{$vendor->email}}</p> </td>
                            </tr>
                            <tr style="flex-direction: column; display: flex; margin-top: 30px;">
