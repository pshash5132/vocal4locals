            ...
            <div class="row">
                <div class="col-lg-12">
                    <table style="width: 100%; max-width: 640px; margin: 0 auto;">
                        <thead>
                            <tr>
                                <td style="text-align: center;"><a href="{{env('APP_URL')}}"><img src="{{asset('frontend')}}/assets/images/logo.svg" style="max-width: 287px;" alt="Vocalforlocal" /></a></td>
                            </tr>
                        </thead>
                        <tbody style="margin: 50px auto 0 !important; width: 100%; display: block; max-width: 560px; border: 1px solid #374850; border-radius: 10px;padding: 43px 35px;">
                            <tr>
                                <td style="font-size: 24px; font-weight: 600; color: #374850;">Forgot your password?</td>
                            </tr>
                            <tr>
                                <td style="font-size: 16px; color: #374850; line-height: 30px; font-weight: 400; margin-top: 15px; display: block;">We have received a password forgot request to your <span style="color: #374850; font-weight: 700;">Vocaal4local's</span> account.</td>
                            </tr>
                            <tr>
                                <td style="font-size: 16px; color: #374850; line-height: 30px; font-weight: 400; margin-top: 35px; display: block;">If you did not ask to forgot your password, then you can ignore this email and your password will not be changed. The link below will remail active for 60 minutes.</td>
                            </tr>
                            <tr>
                                <td><a href="{{$url}}" class="cmn-btn" style="margin-top: 30px;display: inline-block; width: 100%;max-width: 220px;">Reset Password</a></td>
                            </tr>
                        </tbody>
                        <tfoot>
