                ...
                <div class="col-lg-12">
                    <table style="width: 100%; max-width: 640px; margin: 0 auto;">
                        ...
                        <tbody style="margin: 50px auto 0 !important; width: 100%; display: block; max-width: 560px; border: 1px solid #374850; border-radius: 10px;padding: 43px 35px;">
                            ...
                            <tr>
                                <td style="font-size: 16px; color: #374850; line-height: 30px; font-weight: 400; margin-top: 15px; display: block;">We pleasure to have you!  joining under <span style="color: #374850; font-weight: 700;">Vocaal4local's</span> our e-commerce plat form. Your account is under varification, You can login with your account details within 24 hours.</td>
                            </tr>

                            <tr style="flex-direction: column; display: flex; margin-top: 30px;">
                                <td style="display: flex; align-items: center; font-size: 16px; color: #374850; width: 100%;"><span style="display: block; width: 20%;">Username :</span>  <p style="color: #2672EC; font-weight: 600; line-height: 30px; font-size: 16px; margin-bottom: 0;">{{$vendor->name}}</p> </td>
